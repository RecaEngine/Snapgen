...
build-test-model:
	docker buildx build . -t ${REGISTRY}/testmodel:${TAG} -f test/snapgenfile.yaml --output=${OUTPUT_TYPE}
...
.PHONY: test-e2e
test-e2e:
	/home/runner/work/snapgen/snapgen/bin/bats --verbose-run --trace ${BATS_TESTS_FILE}
