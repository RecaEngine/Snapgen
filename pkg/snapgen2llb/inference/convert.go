...
const (
	...
	localAIVersion = "v2.21.1"
	cudaVersion    = "12-5"
)

// Snapgen2LLB converts an InferenceConfig to an LLB state.
func Snapgen2LLB(c *config.InferenceConfig, platform *specs.Platform) (llb.State, *specs.Image, error) {
	var merge llb.State
