    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/sozercan/snapgen/blob/main/website/docs/',
        },
        blog: false,
        theme: {
  ...
  themeConfig:
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          {
            href: 'https://github.com/sozercan/snapgen',
            position: 'right',
