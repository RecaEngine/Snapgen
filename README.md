...
- 🚀 [Easy to use declarative configuration](https://sozercan.github.io/snapgen/specs)
...
For more information and how to create your own images, please see [full documentation](https://sozercan.github.io/snapgen/).
